"""
NovaMart - Database Schema & Table Creation
============================================
Creates all backend tables in the 'app' schema simulating a marketplace e-commerce platform.
"""
...
DDL_STATEMENTS = [
    # Ensure prerequisites exist before creating tables.
...
if __name__ == "__main__":
    ...
    # Try to load .env if available (local dev convenience)
    try:
